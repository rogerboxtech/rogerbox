-- Script para crear la tabla nutritional_blogs en Supabase
...
DROP TRIGGER IF EXISTS update_nutritional_blogs_updated_at ON nutritional_blogs;
...
SELECT 'Tabla nutritional_blogs creada exitosamente' as status;
SELECT COUNT(*) as total_blogs FROM nutritional_blogs;
