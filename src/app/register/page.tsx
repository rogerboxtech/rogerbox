    ...
    <>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#85ea10] items-center justify-center">
        <div className="text-center text-white">
            <h1 className="text-6xl font-black mb-8 tracking-wider">
          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-2xl">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-2">
                ÚNETE A <span className="text-gray-900 dark:text-white">ROGER</span><span className="text-[#85ea10]">BOX</span>
              </h1>
