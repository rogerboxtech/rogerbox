...
export default function RogerBoxMuxPlayer({
  muxPlaybackId,
  videoTitle,
  autoPlay = false,
}: RogerBoxMuxPlayerProps) {
  ...
  // URL del video de Mux
  const muxVideoUrl = `https://stream.mux.com/${muxPlaybackId}.m3u8`;
    ...
    >
      ...
      <div className={`relative w-full ${isFullscreen ? 'h-screen' : 'aspect-video'}`}>
        ...
        <video
          ...
          playsInline
          muted={isMuted}
          poster={`https://image.mux.com/${muxPlaybackId}/thumbnail.jpg?width=1280&height=720&fit_mode=smartcrop`}
        />
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 z-30">
          ...
          >
            <div
              className="bg-[#85ea10] h-full rounded-full transition-all duration-300"
        ...
        <div className="absolute top-4 left-4 z-30">
          <div className="bg-[#85ea10] text-black px-3 py-1 rounded-full text-xs font-semibold">
            HD - RogerBox Player
          </div>
        </div>
